...
public class LocalWorker_version_5 implements Runnable, Callable<String> {

    private Number_version_5 mNumber;
    private ReentrantLock mLock;
    private int mCommand;
    private int mClientID;
    private String mResult;

    public LocalWorker_version_5(Number_version_5 inputNumber, ReentrantLock inputLock, int inputClientID, int command) {
        mNumber = inputNumber;
        mLock = inputLock;
        mResult = "0";
