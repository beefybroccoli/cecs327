...
public class NetworkWorker_version_5 implements Runnable, Callable<String> {
    ...
    public NetworkWorker_version_5(String hostName, int serverPort, int ClientID, String command) {
        mHostName = hostName;
