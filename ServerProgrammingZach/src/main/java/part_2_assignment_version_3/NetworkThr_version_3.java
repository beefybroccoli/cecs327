...
public class NetworkThr_version_3 implements Runnable, Callable<String> {
    ...
    public NetworkThr_version_3(String hostName, int serverPort, int ClientID, String command) {
        mHostName = hostName;
        ...
        try {
            ...
            Logger.getLogger(NetworkThr_version_3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
