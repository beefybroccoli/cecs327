...
public class NetworkThr_version_1 implements Runnable, Callable<String> {
    ...
    public NetworkThr_version_1(String hostName, int serverPort, int ClientID, String command) {
        mHostName = hostName;
        ...
        try {
            ...
            Logger.getLogger(NetworkThr_version_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
