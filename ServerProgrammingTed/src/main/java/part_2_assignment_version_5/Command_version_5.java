...
public class Command_version_5 {
    ...
    public Command_version_5() {
        mResult = "";
    }

    public Command_version_5(int commandID, int requestorID) {
    ...
    public static void test1() {
        Command_version_5[] commands = new Command_version_5[10];

        for (int i = 0; i < 10; i++) {
            int commandID = i + 1;
            int reqestorID = 1;
            commands[i] = new Command_version_5(commandID, reqestorID);
    ...
    public static void test2() {
        Command_version_5 command = new Command_version_5(1, 1);
